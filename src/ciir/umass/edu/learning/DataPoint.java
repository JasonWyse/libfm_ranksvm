...
public class DataPoint {
	...
	public DataPoint(String text)
	{
		...
		try {
			...
			System.arraycopy(fVals, 0, tmp, 0, lastFeature+1);//fVals[0] stores nothing, Feature id starts from 1
			fVals = tmp;
		}
		catch(Exception ex)
		{
	...
	{
		return this.description.substring(this.description.indexOf("=")+1).trim();
	}
